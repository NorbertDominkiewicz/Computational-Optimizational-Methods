...
//        NonlinearEquations nq = new NonlinearEquations(-6, -1, x -> Math.pow(x, 3) - 3 * Math.pow(x, 2) - 20 * x + 1, x-> 3 * Math.pow(x, 2) - 6 * x - 20, x -> 6 * x - 6);
////        nq.bisectionMethod(0.0001);
////        nq.secantMethod(0.02);
////        nq.newtonMethod(0.01);
//        nq.bisectionMethod(0.01);
        NonlinearEquations nq = new NonlinearEquations(-6, -1, x-> 3 * Math.pow(x, 2) - 6 * x - 20, x -> 6 * x - 6, x -> 6.0);
        //nq.bisectionMethod(0.01);
        nq.secantMethod(0.01);
    }
}
